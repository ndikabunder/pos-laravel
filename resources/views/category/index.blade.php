...
@section('content')
    <h1
        ...
        List of <span class="text-blue-600 dark:text-blue-500 underline">category</span>
    </h1>
        ...
        @forelse ($categories as $category)
            <div
                ...
                <div class="p-5">
                    ...
                    <div class="inline-flex rounded-md shadow-sm justify-center w-full mt-8" role="group">
                        <button type="button"
                        ...
                        <button
                            ...
                            type="button" data-modal-toggle="popup-modal-{{ $category->id }}">
                            <svg aria-hidden="true" class="mr-2 w-4 h-4 fill-current" fill="currentColor"
                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                            you sure you want to delete this {{ $category->name }}?</h3>
                                        <form action="{{ route('category.destroy', $category->id) }}" method="POST"
                                            class="inline-flex items-center px-5 py-2.5 text-center mr-2">
                                            @method('DELETE')
                                            @csrf
                                            <div id="ModalDelete{{ $category->id }}">
                                                <button data-modal-toggle="popup-modal-{{ $category->id }}" type="submit"
                                        ...
                                        <button data-modal-toggle="popup-modal-{{ $category->id }}" type="button"
