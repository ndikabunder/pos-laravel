...
@section('content')
    <div class="w-full flex flex-col mt-10 justify-center items-center">
        ...
        <h1
            ...
            Create <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">your</mark> product
        </h1>
        ...
        <div class="mt-14 w-1/3">
            ...
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" class="grid gap-5">
                @csrf
                <div>
